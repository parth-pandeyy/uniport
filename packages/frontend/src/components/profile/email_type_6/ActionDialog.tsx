import { email_type_6_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
type EmailType6ActionDialogType = ActionDialogType<email_type_6_FormBlock>

// EmailType6

export const EmailType6ActionDialog = ({ setOpen, label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: EmailType6ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
