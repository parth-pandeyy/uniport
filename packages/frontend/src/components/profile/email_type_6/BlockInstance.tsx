import { email_type_6_DataBlock } from '@uniport/common';
...
export const EmailType6Block = ({ block_index, data, is_blocked, openDialogToEditOrAddBlock }) => {
	let { verification_info, proof_file_url, value } = data as email_type_6_DataBlock;
