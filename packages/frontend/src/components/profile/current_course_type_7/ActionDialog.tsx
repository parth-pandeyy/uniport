import { current_course_type_7_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
import { FormBlockNumberInput } from "../Utils/FormBlocks/FormBlockNumberInput"
...
type CurrentCourseType7ActionDialogType = ActionDialogType<current_course_type_7_FormBlock>

// CurrentCourseType7

export const CurrentCourseType7ActionDialog = ({ setOpen,label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: CurrentCourseType7ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
								...
								<div className="sm:flex sm:items-start">
									...
									<div>
										...
										<div>
											...
											<FormBlockTextInput
												id='institute_roll'
												placeholder='2018EEBXXXX'
												label='institute_roll'
											/>
											<FormBlockTextInput
												id='program'
												placeholder=''
