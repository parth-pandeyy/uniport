import { single_select_type_3_DataBlock } from '@uniport/common';
...
export const SingleSelectType3Block = ({ block_index, data, options, is_blocked, openDialogToEditOrAddBlock }) => {
	let { verification_info, proof_file_url, value } = data as single_select_type_3_DataBlock;
