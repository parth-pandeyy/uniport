import { phone_number_type_4_DataBlock } from '@uniport/common';
...
export const PhoneNumberType4Block = ({ block_index, data, is_blocked, openDialogToEditOrAddBlock }) => {
	let { verification_info, proof_file_url, ph_number, country_code } = data as phone_number_type_4_DataBlock;
