import { phone_number_type_4_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
type PhoneNumberType4ActionDialogType = ActionDialogType<phone_number_type_4_FormBlock>

// PhoneNumberType4

export const PhoneNumberType4ActionDialog = ({ setOpen, label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: PhoneNumberType4ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
