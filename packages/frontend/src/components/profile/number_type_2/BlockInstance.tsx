import { number_type_2_DataBlock } from '@uniport/common';
...
export const NumberType2Block = ({ block_index, data, is_blocked, openDialogToEditOrAddBlock }) => {
	let { verification_info, proof_file_url, value } = data as number_type_2_DataBlock;
