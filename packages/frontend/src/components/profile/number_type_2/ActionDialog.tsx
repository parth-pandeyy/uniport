import { number_type_2_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
type NumberType2ActionDialogType = ActionDialogType<number_type_2_FormBlock>

// NumberType2

export const NumberType2ActionDialog = ({ setOpen, label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: NumberType2ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
