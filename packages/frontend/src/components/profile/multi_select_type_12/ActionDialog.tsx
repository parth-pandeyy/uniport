import { multi_select_type_12_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
import { FormBlockMultiSelect } from "../Utils/FormBlocks/FormBlockMultiSelect"
...
type MultiSelectType12ActionDialogType = ActionDialogType<multi_select_type_12_FormBlock> & { options: any[] }

// MultiSelectType12

export const MultiSelectType12ActionDialog = ({ setOpen, label, open, waitingForServerResponse, options, initialValues, handleSubmit, errorMessage, successMessage }: MultiSelectType12ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
