import { address_type_5_DataBlock, address_type_5_FormBlock, address_type_5_InputPayload } from "@uniport/common";
...
import { AddressType5ActionDialog } from "./ActionDialog";
import { AddressType5Block } from "./BlockInstance";


// default values (to be used while adding a new block from scratch)
const noValue: address_type_5_FormBlock = {
	address_line: '',
	block_proof_data: '',
	city: '',
	country: '',
...
export const AddressType5Pilot = ({ meta }) => {
	let {
		attribute_id,
		attribute_type,
		is_array,
	...
	const handleSubmit = async (e: address_type_5_DataBlock) => {
		try {
			setLoading(true);
			setSuccessMessage('');
			setError(null);

			let payload: address_type_5_InputPayload = {
				...e,
				student_id,
				attribute_id,
				attribute_type,
