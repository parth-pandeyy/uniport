import { address_type_5_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
type AddressType5ActionDialogType = ActionDialogType<address_type_5_FormBlock>

// AddressType5

export const AddressType5ActionDialog = ({ setOpen, label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: AddressType5ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
