import { date_type_1_FormBlock, education_type_8_FormBlock } from "@uniport/common"
...
type DateType1ActionDialogType = ActionDialogType<date_type_1_FormBlock>

// DateType1

export const DateType1ActionDialog = ({ setOpen, label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: DateType1ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
