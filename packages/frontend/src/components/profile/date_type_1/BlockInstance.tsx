import { date_type_1_DataBlock } from '@uniport/common';
...
export const DateType1Block = ({ block_index, data, is_blocked, openDialogToEditOrAddBlock }) => {
	let { verification_info, proof_file_url, value } = data as date_type_1_DataBlock;
