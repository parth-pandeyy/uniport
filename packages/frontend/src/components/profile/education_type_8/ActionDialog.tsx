import { education_type_8_FormBlock } from "@uniport/common"
...
type EducationType8ActionDialogType = ActionDialogType<education_type_8_FormBlock>

// EducationType8

export const EducationType8ActionDialog = ({ setOpen,label, open, waitingForServerResponse, initialValues, handleSubmit, errorMessage, successMessage }: EducationType8ActionDialogType) => {
	return (
		<GenericModal
			setOpen={setOpen}
			open={open}
